...
artist1 = Artist.create({name: "Kendrick Lamar", user_id: 1, artist_img: "https://images.genius.com/25d8a9c93ab97e9e6d5d1d9d36e64a53.1000x1000x1.jpg", header_img: "https://images.genius.com/7e47ca9b2b911cc5c65d00d5a57b28c3.1000x667x1.jpg"})
artist2 = Artist.create({name: "Chance the Rapper", user_id: 1, artist_img: "https://images.genius.com/d5771671554a8976b034671291d2bca7.527x527x1.jpg", header_img: "https://images.genius.com/77453746293dc66ca7440e370f4fa877.1000x370x1.jpg"})
artist3 = Artist.create({name: "Ariana Grande", user_id: 3, artist_img: "https://images.genius.com/285268c9b4e93680f6e01377fb478df9.814x814x1.jpg", header_img: "https://images.genius.com/a98083361dde78473428804054595c82.950x459x1.jpg"})
artist4 = Artist.create({name: "Queen", user_id: 2, artist_img: "https://images.genius.com/781f51bb7041e6b7eeec820fbc413e75.1000x750x1.jpg", header_img: "https://images.genius.com/fe643c1cd9be97167e97a99c182e6051.960x360x1.jpg"})
artist5 = Artist.create({name: "Drake", user_id: 2, artist_img: "https://images.genius.com/d88b9e6b78704998334786ea8fef35b8.1000x1000x1.jpg", header_img: "https://images.genius.com/5c193a2c4cae5eaa8754a9f715ea7886.1000x562x1.jpg"})
artist6 = Artist.create({name: "Ed Sheeran", user_id: 2, artist_img: "https://images.genius.com/1ff6b6189e1a78e497e09c90c1f6692e.1000x1000x1.jpg", header_img: "https://images.genius.com/9b501d1e2fedb6654f9f7f078a14679d.1000x667x1.jpg"})
artist7 = Artist.create({name: "6lack", user_id: 3, artist_img: "https://images.genius.com/103257aeaf421fb834abe9d35aa2fabf.640x640x1.jpg", header_img: "https://images.genius.com/7e89d747617efbbf36d9b14317ad0a39.1000x800x1.jpg"})
